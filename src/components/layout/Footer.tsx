...
const footerLinks = {
    Shows: [
        ...
        { label: "Opinion Junkyard", href: "/shows/opinion-junkyard" },
        { label: "100 Ways", href: "/shows/100-ways" },
        { label: "HyphyTown", href: "/shows/hyphytown" },
    ],
    Company: [
    ...
    Legal: [
        ...
        { label: "Contact", href: "mailto:info@multivisionnetwork.com" },
    ],
};
    ...
    return (
        <footer className="border-t border-brand-border bg-brand-black">
            <div className="mx-auto max-w-7xl px-6 py-16 md:px-12">
                ...
                <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-sm text-brand-text-secondary leading-relaxed max-w-xs">
                            Building, launching, and scaling culture-driven podcasts and digital media brands.
                        </p>
                        {/* Socials */}
                    ...
                    {Object.entries(footerLinks).map(([category, links]) => (
                        <div key={category}>
                            <h4 className="font-heading text-sm font-bold uppercase tracking-wider text-brand-text mb-4">
                                {category}
                            </h4>
                ...
                {/* Divider */}
                <div className="my-12 h-px bg-gradient-to-r from-transparent via-brand-border to-transparent" />

                {/* Bottom */}
                <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
                    <p className="text-xs text-brand-text-secondary">
                        © {new Date().getFullYear()} Multivision Network. All rights reserved.
                    </p>
                    <p className="text-xs text-brand-text-secondary">
                        Built for culture. Designed for growth.
                    </p>
                </div>
            </div>
        </footer>
